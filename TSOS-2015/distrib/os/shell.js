...
(function (TSOS) {
    var Shell = (function () {
        ...
        Shell.prototype.init = function () {
            ...
            this.commandList[this.commandList.length] = sc;
            sc = new TSOS.ShellCommand(this.shellCoord, "coord", "- Displays your current location.");
            this.commandList[this.commandList.length] = sc;
        ...
        Shell.prototype.shellCoord = function (args, std) {
            std = std || _Std;
            var coord;
            _StdOut.accuracy("you are located " + std.Out.accuracy.toString());
        };
        return Shell;
    })();
    TSOS.Shell = Shell;
